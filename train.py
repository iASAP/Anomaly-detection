...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset_path', type=str, default='../../../../../data/ucsd/dataset/', help='directory of data')
    ...
    model = convAE(n_channel, args.t_length, args.msize, args.fdim, args.mdim)
